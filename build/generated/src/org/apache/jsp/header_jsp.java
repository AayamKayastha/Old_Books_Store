...
public final class header_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("\n");
      out.write("<style>\n");
      out.write("            .page_header form{margin-left: 900px;margin-top: 0px;}\n");
      out.write("            .page_header span {font-size: 12px;} \n");
      out.write("            .page_header input{width: 85px;}\n");
      out.write("            .page_header #login{width: 70px;border-radius: 5px 50px;background: #5499C7;border-color: white;}\n");
      out.write("            .page_header #register{margin-left: 900px; width: 70px; border-radius: 5px 50px;background: #5499C7;border-color: white;padding: 8px;}\n");
      out.write("            .page_header{background: #3498DB; border-radius: 5px 50px 105px;}\n");
      out.write("            .page_header .PageName{font-family: fantasy;font-size: 60px;padding: 10px;}\n");
      out.write("            #user{margin-left: 900px;border-radius: 5px 50px;background: #7FB3D5;border-color: white;}\n");
      out.write("</style>\n");
      out.write("<div class=\"page_header\">\n");
      out.write("    <div class=\"PageName\">Old Books</div>\n");
      if (_jspx_meth_c_choose_0(_jspx_page_context))
        return;
      out.write("\n");
      out.write("</div>\n");
      out.write("<!--<table width=\"90%\" height=\"30%\"><tr bgcolor=\"#3c6ab7\"><th>Old Books</th><th></th></tr>\n");
      out.write("    <tr><td></td><td></td></tr></table>-->");
    } catch (Throwable t) {
  ...
  private boolean _jspx_meth_s_query_0(PageContext _jspx_page_context)
    ...
    try {
      ...
      if (_jspx_eval_s_query_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        ...
        do {
          out.write("select * from loginDetails;");
  ...
  private boolean _jspx_meth_c_when_0(javax.servlet.jsp.tagext.JspTag _jspx_th_c_choose_0, PageContext _jspx_page_context)
    ...
    _jspx_th_c_when_0.setTest(((java.lang.Boolean) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${sessionScope['name']==null}", java.lang.Boolean.class, (PageContext)_jspx_page_context, null)).booleanValue());
    int _jspx_eval_c_when_0 = _jspx_th_c_when_0.doStartTag();
    if (_jspx_eval_c_when_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
      do {
        out.write("\n");
        out.write("    <form action=\"Login\" method=\"post\"><table><tr><td><span>Email:</span></td><td><span>Password:</span></td></tr><tr><td><input type=\"text\" name=\"mail\" id=\"mail\"></td><td><input id=\"passwor2d\" type=\"password\" name=\"password\"></td><td><input type=\"submit\" value=\"Login\" id=\"login\"></td></tr></table></form>\n");
        out.write("    <a href=\"Register.jsp\"><button id=\"register\" type=\"button\" name=\"Register\">Register</button></a>\n");
        out.write("    ");
  ...
  private boolean _jspx_meth_c_otherwise_0(javax.servlet.jsp.tagext.JspTag _jspx_th_c_choose_0, PageContext _jspx_page_context)
    ...
    if (_jspx_eval_c_otherwise_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
      do {
        out.write("\n");
        out.write("    <a href=\"userPage.jsp\"><button type=\"button\" id=\"user\">");
